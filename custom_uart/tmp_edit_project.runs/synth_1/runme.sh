...
HD_PWD='E:/KITCODE/Scope/repo/axi_lvds_2/tmp_edit_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_lvds_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_lvds_v1_0.tcl
