...
BEGIN DRIVER
 ...
 PARAMETER DRIVER_VER = 3.5
 PARAMETER HW_INSTANCE = IIC_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = iic
 PARAMETER DRIVER_VER = 3.5
 PARAMETER HW_INSTANCE = IIC_2
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = uartlite
 PARAMETER DRIVER_VER = 3.2
 PARAMETER HW_INSTANCE = RS_485_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = uartlite
 PARAMETER DRIVER_VER = 3.2
 PARAMETER HW_INSTANCE = RS_485_2
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.4
 PARAMETER HW_INSTANCE = RS_485_EN
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = spi
 PARAMETER DRIVER_VER = 4.4
 PARAMETER HW_INSTANCE = SPI_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = spi
 PARAMETER DRIVER_VER = 4.4
 PARAMETER HW_INSTANCE = SPI_2
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = axi_ddr_wr_test
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = axi_ddr_wr_test_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axi_ddr_wr_test
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = axi_ddr_wr_test_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axi_ddr_wr_test
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = axi_ddr_wr_test_2
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axi_ddr_wr_test
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = axi_ddr_wr_test_3
END
